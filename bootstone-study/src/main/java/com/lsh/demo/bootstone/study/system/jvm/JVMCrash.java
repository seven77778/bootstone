package com.lsh.demo.bootstone.study.system.jvm;
...
public class JVMCrash {
    ...
    /*举个栗子
        ...
        #
        Current thread (0x14ea6800):  JavaThread "Finalizer" daemon [_thread_in_native, id=1496, stack(0x15120000,0x15170000)]
